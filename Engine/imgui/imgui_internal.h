...
namespace ImGui
{
    ...
    IMGUI_API bool          SliderFloatN(const char* label, float* v, int components, float v_min, float v_max, bool print_label, const char* display_format, float power);
    IMGUI_API bool          SliderIntN(const char* label, int* v, int components, int v_min, int v_max, bool print_label, const char* display_format);
